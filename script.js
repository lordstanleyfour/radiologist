...
elbowGood1.src = "elbowgood.png";
const elbowGood2 = new Image ();
elbowGood2.src = "elbowgood1.png";
const elbowGood3 = new Image ();
elbowGood3.src = "elbowgood2.png";
const handGood = new Image ();
handGood.src = "handgood.png";
xrayImages.push(chestGood, footGood, kneeGood, kneeGood1, pelvisGood1, pelvisGood2, wristGood, elbowGood1, elbowGood2, elbowGood3, handGood)
...
const chestWrong = new Image ();
chestWrong.src = "chestwrong.png";
...
xrayImages.push(chestBad1, chestBad2, chestBad3, chestWrong, detector, footBad1, footBad2, kneeBad, pelvisBad1, wristBad1, wristBad2);
...
function chooseReferralText(){
  ...
  else if (imagePrime === pelvisBad1 || imagePrime === pelvisGood1 || imagePrime === pelvisGood2 || imagePrime === chestWrong) refText = "PELVIS";
  else if (imagePrime === elbowGood1 || imagePrime === elbowGood2 || imagePrime === elbowGood3) refText = "ELBOW";
...
function keyPressHandler(){
  ...
  if (keys[65]/*A*/&& imagePrime !== startImage) {
    if (imagePrime === chestGood || imagePrime === footGood || imagePrime === kneeGood || imagePrime === kneeGood1 || imagePrime === pelvisGood1 || imagePrime === pelvisGood2 || imagePrime === wristGood || imagePrime === elbowGood1 || imagePrime === elbowGood2 || imagePrime === elbowGood3 || imagePrime === handGood) {
      score += 2;
      roll = true;
    } else {
      score -= 5;
  ...
  if (keys[68]/*D*/&& imagePrime !== startImage) {
    if (imagePrime === chestBad1 || imagePrime === chestBad2 || imagePrime === chestBad3 || imagePrime === detector || imagePrime === footBad1 || imagePrime === footBad2 || imagePrime === kneeBad || imagePrime === pelvisBad1 || imagePrime === wristBad1 || imagePrime === wristBad2 || imagePrime === chestWrong) {
      score +=2;
      roll = true;
    } else {
      score -=5;
